...
from models import db, Student, Faculty , Scores
...
def add_data():
    ...
    for i in range(1, 6):
        score = Scores(gender_study=random.choice(['Math', 'Foo']),
    ...
    #     score = Scores(
    #         name=f'score{i}',
    #         id_student=random.randint(1, 3),
    #         gender_study=random.choice(['Math', 'Foo']),
    #         score=random.randint(1, 5)
    #     )
    #     db.session.add(score)
